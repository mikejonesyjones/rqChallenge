...
public class RetryingEmployeeRepositoryTest
{
    ...
    void testGetAllEmployees()
    {
        ...
        when(delegateRepository.getAllEmployees()).thenThrow(RestClientException.class)
    ...
    public void testGetEmployee()
    {
        ...
        when(delegateRepository.getEmployee(id)).thenThrow(RestClientException.class)
                                                .thenThrow(RestClientException.class)
                                                .thenReturn(employee);
    ...
    public void testDeleteEmployee()
    {
        final String id = "id";
        final Employee employee = mock(Employee.class);
        when(delegateRepository.deleteEmployee(id)).thenThrow(RestClientException.class)
                                                   .thenThrow(RestClientException.class)
                                                   .thenReturn(employee);
    ...
    public void testCreateEmployee()
    {
        ...
        final Employee employee = mock(Employee.class);
        when(delegateRepository.createEmployee(details)).thenThrow(RestClientException.class)
                                                   .thenThrow(RestClientException.class)
                                                   .thenReturn(employee);
