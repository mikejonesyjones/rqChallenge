...
public final class TestUtils
{
     ...
     */
    public static CompletableFuture<Process> startServer(String jarPath, int port, String readyLogLine,
                                                         String... extraArgs)
    {
        return CompletableFuture.supplyAsync(() -> {
            try
            {
                final String[] allArgs = Stream.concat(Stream.of("java", "-jar", jarPath, "--server.port=" + port),
                                                       Stream.of(extraArgs))
                                               .toArray(String[]::new);
